...
> Movies Trailer webpage is a project, comprising of a front end and a backend. Based on user provided list of movies, movies trailer webpage is constructed. User can click on movie tile to play its corresponding YouTube trailer. Its backend comprises of python classes to store the movie information and supply the objects instantiated (of different user choice movies) to construct a trailer webpage.
